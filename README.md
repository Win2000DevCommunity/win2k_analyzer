...
- **Tested with real patched kernel:** 82 unique symbols injected (89 exports, some sharing addresses via Nt/Zw pairs), PDB grows from 7,687 → 7,767 symbols. All new functions visible in WinDbg (`x ntkrnlpa!DbgPrintEx`, etc.).
